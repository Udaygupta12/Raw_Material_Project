...
{
    private RecyclerView findDoctorsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findDoctorsList=findViewById(R.id.find_doctors_list);
        findDoctorsList.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts, FindDoctorsViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Contacts, FindDoctorsViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull FindDoctorsViewHolder holder, final int position, @NonNull final Contacts model) {
                    ...
                    @NonNull
                    @Override
                    public FindDoctorsViewHolder onCreateViewHolder(@NonNull ViewGroup p, int viewType) {
                        View view = LayoutInflater.from(p.getContext()).inflate(R.layout.contact_design, p, false);
                        FindDoctorsViewHolder viewHolder = new FindDoctorsViewHolder(view);
                        return viewHolder;
                    }
                };

                findDoctorsList.setAdapter(firebaseRecyclerAdapter);
    ...
    public static class FindDoctorsViewHolder extends RecyclerView.ViewHolder {
        ...
        public FindDoctorsViewHolder(@NonNull View itemView) {
            super(itemView);
