...
public class ProfileActivity extends AppCompatActivity
{
   ...
   private Button add_friend,decline_freind_request;
   ...
   private DatabaseReference friendRequestRef, contactsRef;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        decline_freind_request=findViewById(R.id.decline_friend_request);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.hasChild(receiverUserID))
                        {
                            ...
                            else if (requestType.equals("received"))
                            {
                                ...
                                decline_freind_request.setVisibility(View.VISIBLE);
                                decline_freind_request.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                                                            ...
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task)
                                                                                {
                                                                                    if (task.isSuccessful())
                                                                                    {
                                                                                        ...
                                                                                        decline_freind_request.setVisibility(View.GONE);
